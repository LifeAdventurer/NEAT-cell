        ...
        for j in range(25):
            for i in range(5):
                sensor_front = Sensor(
                    self.rect.center[0]
                    + (15 + 20 * i)
                    * np.cos(((self.degree - 90 + 7.5 * j) / 180) * 3.14159),
                    self.rect.center[1]
                    + (15 + 20 * i)
                    * np.sin(((self.degree - 90 + 7.5 * j) / 180) * 3.14159),
                )
        ...
        for j in range(13):
            for i in range(5):
                sensor_front = Sensor(
                    self.rect.center[0]
                    + (15 + 20 * i)
                    * np.cos(((self.degree - 30 + 5 * j) / 180) * 3.14159),
                    self.rect.center[1]
                    + (15 + 20 * i)
                    * np.sin(((self.degree - 30 + 5 * j) / 180) * 3.14159),
                )
...
for i in range(POP_B):
    ...
    cell = Cell_B(
        np.random.randint(5, WIDTH - 5),
        np.random.randint(5, HEIGHT - 5),
        weight1,
        weight2,
    )
    cell_B.add(cell)
...
while running:
    ...
    for i in range(3):
        cell = Nutrient(
            np.random.randint(5, WIDTH - 5), np.random.randint(5, HEIGHT - 5)
        )
        nutrient.add(cell)
